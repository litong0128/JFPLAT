...
$(function() {
	...
	var reportfile_m = "/woygzc/woego_by_crowdfunding_trade_m.raq";//月报表文件
	var reportfile_d = "/woygzc/woego_by_crowdfunding_trade_d.raq";//日报表文件
	var reportfile_w = "/woygzc/woego_by_crowdfunding_trade_w.raq";//周报表文件
...
<body>
	...
	<form action="${pageContext.request.contextPath}/woygzc_report_.action" method="post" target="reportFrame">
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/woygzc/woego_by_crowdfunding_trade_d.raq"/>
