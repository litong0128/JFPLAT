...
String reportTitle = "交费通支付工具支付失败情况报表";
%>  
...
$(function() {
	...
	var reportfile_m = "/zhht/jft/tas_payment_fail_m.raq";//月报表文件
	var reportfile_d = "/zhht/jft/tas_payment_fail_d.raq";//日报表文件
...
<body>
	...
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/zhht/jft/tas_payment_fail_d.raq"/>
