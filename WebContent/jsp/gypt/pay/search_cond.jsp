...
$(function() {
	...
	var text = "业务场景&nbsp;";
	var mUrl = "${pageContext.request.contextPath}/getData_busiScenarioData.action?proflag=005"; //获取数据的url
	popBoxHtml(outObj, pre, text);
	popBoxAction(pre, mUrl);
	...
	var pre = "payTool";
	var text = "支付工具&nbsp;";
	var mUrl = "${pageContext.request.contextPath}/getData_payToolData.action?proflag=002"; //获取数据的url
	popBoxHtml(outObj, pre, text);
	popBoxAction(pre, mUrl);
	...
	var reportfile_m = "/gypt/adl_comw_org_pay_fee_m.raq";//月报表文件
	var reportfile_d = "/gypt/adl_comw_org_pay_fee_d.raq";//日报表文件
...
<body>
	...
	<form action="${pageContext.request.contextPath}/gypt_report_.action" method="post" target="reportFrame">
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/gypt/adl_comw_org_pay_fee_d.raq"/>
