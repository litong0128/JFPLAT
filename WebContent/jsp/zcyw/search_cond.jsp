...
$(function() {
	...
	var reportfile_m = "/zcyw/crowdfunding_busi_m.raq";//月报表文件
	var reportfile_d = "/zcyw/crowdfunding_busi_d.raq";//日报表文件
...
<body>
	...
	<form action="${pageContext.request.contextPath}/zcyw_report_.action" method="post" target="reportFrame">
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/zcyw/crowdfunding_busi_d.raq"/>
