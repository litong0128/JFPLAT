...
$(function() {
	...
	var reportfile_m = "/jrtdfx/adl_coop_shortcuts_sign_d.raq";//月报表文件
	var reportfile_d = "/jrtdfx/adl_coop_shortcuts_sign_d.raq";//日报表文件
	var reportfile_w = "/jrtdfx/adl_coop_shortcuts_sign_d.raq";//周报表文件
...
<body>
	...
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/jrtdfx/adl_coop_shortcuts_sign_d.raq"/>
