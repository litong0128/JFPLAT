...
String reportTitle = "账户互通开通沃账户报表";
%>  
...
$(function() {
	...
	var reportfile_m = "/zhht/wozh/tas_wo_create_user_m.raq";//月报表文件
	var reportfile_d = "/zhht/wozh/tas_wo_create_user_d.raq";//日报表文件
...
<body>
	...
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/zhht/wozh/tas_wo_create_user_d.raq"/>
