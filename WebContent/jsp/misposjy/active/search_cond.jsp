...
$(function() {
	...
	var reportfile_m = "/misposjy/mispos_activation_d.raq";//月报表文件
	var reportfile_d = "/misposjy/mispos_activation_d.raq";//日报表文件
...
<body>
	...
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/misposjy/mispos_activation_d.raq"/>
