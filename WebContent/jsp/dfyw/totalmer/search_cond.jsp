...
$(function() {
	...
	var reportfile_m = "/dfyw/adl_payroll_total_mer_d.raq";//月报表文件
	var reportfile_d = "/dfyw/adl_payroll_total_mer_d.raq";//日报表文件
	var reportfile_w = "/dfyw/adl_payroll_total_mer_d.raq";//周报表文件
...
<body>
	...
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/dfyw/adl_payroll_total_mer_d.raq"/>
