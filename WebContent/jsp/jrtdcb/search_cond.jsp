...
<body>
	...
	<div id="reportContent"><img alt="#" src="images/magnifier.gif">&nbsp;&nbsp;金融通道成本收益表</div>
	<form action="${pageContext.request.contextPath}/jrtdcb_report_.action" method="post" target="reportFrame">
	<input type="hidden" name="reportCondis.reportName" value="/jrtdcb/coop_income_cost_m.raq"/>
