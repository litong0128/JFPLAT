	...
	$(function() {
		...
		$("#reportType").change(function(){
			if($(this).val() == "mReport"){
				//月
				dateFlag = 0;
				$("input[name='reportCondis.reportName']").val('/llhyyqy/llh_signinfo_m.raq');
				...
				//日
				dateFlag = 1;
				$("input[name='reportCondis.reportName']").val('/llhyyqy/llh_signinfo_d.raq');
				...
				//周
				dateFlag = 2;
				$("input[name='reportCondis.reportName']").val('/llhyyqy/llh_signinfo_w.raq');
				$( "#startDate" ).datepicker( "option", "dateFormat", "yy/mm/dd" );
				$( "#endDate" ).datepicker( "option", "dateFormat", "yy/mm/dd" );
				//更改最大最小时间限制
				$( "#endDate" ).datepicker( "option", "minDate", new Date("1900","1","1") );
...
<body>
	...
	<div id="reportContent"><img alt="#" src="images/magnifier.gif">&nbsp;&nbsp;零零花运营签约报表</div>
	<form action="${pageContext.request.contextPath}/llhyyqy_report_.action" method="post" target="reportFrame">
	<input type="hidden" name="reportCondis.reportName" value="/llhyyqy/llh_signinfo_m.raq"/>
