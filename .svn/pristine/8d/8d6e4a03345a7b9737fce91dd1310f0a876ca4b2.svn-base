...
$(function() {
	...
	var reportfile_m = "/misposzjgj/mis_pos_deposite_w.raq";//月报表文件
	var reportfile_d = "/misposzjgj/mis_pos_deposite_w.raq";//日报表文件
	var reportfile_w = "/misposzjgj/mis_pos_deposite_w.raq";//周报表文件
...
<body>
	...
	<form action="${pageContext.request.contextPath}/misposzjgj_report_.action" method="post" target="reportFrame">
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/misposzjgj/mis_pos_deposite_w.raq"/>
