...
String reportTitle = "账户互通用户奖励日报表";
%>  
...
$(function() {
	...
	var reportfile_m = "/zhht/jl/adl_tas_user_reward_d.raq";//月报表文件
	var reportfile_d = "/zhht/jl/adl_tas_user_reward_d.raq";//日报表文件
	var reportfile_w = "/zhht/jl/adl_tas_user_reward_d.raq";//周报表文件
...
<body>
	...
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/zhht/jl/adl_tas_user_reward_d.raq"/>
