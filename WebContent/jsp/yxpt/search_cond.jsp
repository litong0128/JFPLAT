...
$(function() {
	...
	var reportfile_m = "/yxpt/adl_rap_market_m.raq";//月报表文件
	var reportfile_d = "/yxpt/adl_rap_market_d.raq";//日报表文件
...
<body>
	...
	<form action="${pageContext.request.contextPath}/yxpt_report_.action" method="post" target="reportFrame">
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/yxpt/adl_rap_market_d.raq"/>
