...
<body>
	...
	<div id="reportContent"><img alt="#" src="images/magnifier.gif">&nbsp;&nbsp;代理商资金归集用户交易报表</div>
	<form action="${pageContext.request.contextPath}/dlszjgj_report_.action" method="post" target="reportFrame">
	<input type="hidden" name="reportCondis.reportName" value="/dlszjgj/cash_collect_trade_user_m.raq"/>
