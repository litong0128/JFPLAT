...
$(function() {
	...
	var reportfile_m = "/woygzc/woego_by_prov_trade_m.raq";//月报表文件
	var reportfile_d = "/woygzc/woego_by_prov_trade_m.raq";//日报表文件
	var reportfile_w = "/woygzc/woego_by_prov_trade_m.raq";//周报表文件
...
<body>
	...
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/woygzc/woego_by_prov_trade_m.raq"/>
