...
String reportTitle = "线下POS分期手续费收入报表";
%>  
...
$(function() {
	...
	var reportfile_m = "/xxposfq/offline_pos_installment_income_m.raq";//月报表文件
	var reportfile_d = "/xxposfq/offline_pos_installment_income_d.raq";//日报表文件
...
<body>
	...
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/xxposfq/offline_pos_installment_income_d.raq"/>
