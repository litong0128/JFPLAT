...
/**
 * Filename:JrtdfxReportAction.java
 * Description: 金融通道分析
 * @author litong
...
@Controller  
@Scope("prototype")  
public class JrtdfxReportAction extends BaseActionSupport {

	private static Logger logger = Logger.getLogger(JrtdfxReportAction.class);
