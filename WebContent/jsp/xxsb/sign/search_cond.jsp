...
$(function() {
	...
	var reportfile_m = "/xxsb/adl_mkte_sign_m.raq";//月报表文件
	var reportfile_d = "/xxsb/adl_mkte_sign_d.raq";//日报表文件
	var reportfile_w = "/xxsb/adl_mkte_sign_d.raq";//周报表文件
...
<body>
	...
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/xxsb/adl_mkte_sign_d.raq"/>
