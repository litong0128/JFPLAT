...
$(function() {
	...
	var reportfile_m = "/gypt/adl_comw_trade_m.raq";//月报表文件
	var reportfile_d = "/gypt/adl_comw_trade_d.raq";//日报表文件
...
<body>
	...
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/gypt/adl_comw_trade_d.raq"/>
