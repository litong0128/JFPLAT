...
$(function() {
	...
	var reportfile_m = "/dfyw/adl_payroll_fail_reason_m.raq";//月报表文件
	var reportfile_d = "/dfyw/adl_payroll_fail_reason_d.raq";//日报表文件
	var reportfile_w = "/dfyw/adl_payroll_fail_reason_d.raq";//周报表文件
...
<body>
	...
	<form action="${pageContext.request.contextPath}/dfyw_report_.action" method="post" target="reportFrame">
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/dfyw/adl_payroll_fail_reason_d.raq"/>
	...
	<table id="filters"  class="ui-widget" style="width:100%;">
		...
		<tr>
			<td>账户类型：</td><td><div id="cardType"></div></td>
			<td>代发类型：</td><td><div id="payTool"></div></td>
