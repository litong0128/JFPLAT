...
String reportTitle = "线下POS分期消费月报表" ;
%>  
...
$(function() {
	...
	var reportfile_m = "/xxposfq/offline_pos_consume_m.raq";//月报表文件
	var reportfile_d = "/xxposfq/offline_pos_consume_d.raq";//日报表文件
...
<body>
	...
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/xxposfq/offline_pos_consume_m.raq"/>
