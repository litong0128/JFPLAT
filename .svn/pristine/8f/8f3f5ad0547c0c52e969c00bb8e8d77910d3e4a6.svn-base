...
String reportTitle = "MISPOS招联分期手续费成本月报" ;
%>  
...
$(function() {
	...
	var reportfile_m = "/misposfq/mucfc_pos_installment_cost_m.raq";//月报表文件
	var reportfile_d = "/misposfq/mucfc_pos_installment_cost_m.raq";//日报表文件
...
<body>
	...
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/misposfq/mucfc_pos_installment_cost_m.raq"/>
