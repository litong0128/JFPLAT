...
$(function() {
	...
	var reportfile_m = "/xxsb/adl_mkte_trade_m.raq";//月报表文件
	var reportfile_d = "/xxsb/adl_mkte_trade_d.raq";//日报表文件
	var reportfile_w = "/xxsb/adl_mkte_trade_d.raq";//周报表文件
...
<body>
	...
	<form action="${pageContext.request.contextPath}/xxsb_report_.action" method="post" target="reportFrame">
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/xxsb/adl_mkte_trade_d.raq"/>
