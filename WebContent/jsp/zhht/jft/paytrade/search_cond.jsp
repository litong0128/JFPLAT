...
String reportTitle = "交费通充值交费情况报表";
%>  
...
$(function() {
	...
	var reportfile_m = "/zhht/jft/tas_pay_trade_m.raq";//月报表文件
	var reportfile_d = "/zhht/jft/tas_pay_trade_d.raq";//日报表文件
...
<body>
	...
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/zhht/jft/tas_pay_trade_d.raq"/>
