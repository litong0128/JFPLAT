...
$(function() {
	...
	var reportfile_m = "/wxsxf/adl_ten_commission_d.raq";//月报表文件
	var reportfile_d = "/wxsxf/adl_ten_commission_d.raq";//日报表文件
	var reportfile_w = "/wxsxf/adl_ten_commission_d.raq";//周报表文件
...
<body>
	...
	<form action="${pageContext.request.contextPath}/wxsxf_report_.action" method="post" target="reportFrame">
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/wxsxf/adl_ten_commission_d.raq"/>
