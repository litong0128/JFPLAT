...
String reportTitle = "线下POS分期撤销退款月报表";
%>  
...
$(function() {
	...
	var reportfile_m = "/xxposfq/offline_pos_withdraw_m.raq";//月报表文件
	var reportfile_d = "/xxposfq/offline_pos_withdraw_d.raq";//日报表文件
...
<body>
	...
	<form action="${pageContext.request.contextPath}/xxposfq_report_.action" method="post" target="reportFrame">
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/xxposfq/offline_pos_withdraw_m.raq"/>
