...
<body>
	...
	<div id="reportContent"><img alt="#" src="images/magnifier.gif">&nbsp;&nbsp;信用卡分期业务成本报表</div>
	<form action="${pageContext.request.contextPath}/xykfq_report_.action" method="post" target="reportFrame">
	<input type="hidden" name="reportCondis.reportName" value="/xykfq/credit_card_installment_cost.raq"/>
