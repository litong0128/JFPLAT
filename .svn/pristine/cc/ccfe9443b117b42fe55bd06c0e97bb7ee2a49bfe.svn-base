...
//时间控件精确到年的onclose事件
		...
		$("#reportType").change(function(){
			if($(this).val() == "mReport"){
				//月
				dateFlag = 0;
				$("input[name='reportCondis.reportName']").val('/woaccount/wo_user_source_login_m.raq');
				...
				//日
				dateFlag = 1;
				$("input[name='reportCondis.reportName']").val('/woaccount/wo_user_source_login_d.raq');
				...
				//周
				dateFlag = 2;
				$("input[name='reportCondis.reportName']").val('/woaccount/wo_user_source_login_w.raq');
				$( "#startDate" ).datepicker( "option", "dateFormat", "yy/mm/dd" );
				$( "#endDate" ).datepicker( "option", "dateFormat", "yy/mm/dd" );
				//更改最大最小时间限制
				$( "#endDate" ).datepicker( "option", "minDate", new Date("1900","1","1") );
			...
			}else if($(this).val() == "yReport"){
				//周
				dateFlag = 3;
				$("input[name='reportCondis.reportName']").val('/woaccount/wo_user_source_login_y.raq');
				$( "#startDate" ).datepicker( "option", "dateFormat", "yy/mm/dd" );
				$( "#endDate" ).datepicker( "option", "dateFormat", "yy/mm/dd" );
				//更改最大最小时间限制
				$( "#endDate" ).datepicker( "option", "minDate", new Date("1900","1","1") );
...
<body>
	...
	<div id="reportContent"><img alt="#" src="images/magnifier.gif">&nbsp;&nbsp;沃账户登录报表</div>
	<form action="${pageContext.request.contextPath}/wo_account_report_.action" method="post" target="reportFrame">
	<input type="hidden" name="reportCondis.reportName" value="/woaccount/wo_user_source_login_m.raq"/>
	<table id="filters"  class="ui-widget" style="width:100%;">
		<tr>
			...
			<select id="reportType" class="text ui-widget-content ui-corner-all">
				...
				<option value="yReport">年报</option>
			</select>
			</td>
