...
String reportTitle = "账户互通沃账户绑卡报表" ;
%>  
...
$(function() {
	...
	var reportfile_m = "/zhht/wozh/tas_wo_bindcard_m.raq";//月报表文件
	var reportfile_d = "/zhht/wozh/tas_wo_bindcard_d.raq";//日报表文件
...
<body>
	...
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/zhht/wozh/tas_wo_bindcard_d.raq"/>
