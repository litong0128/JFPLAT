...
String reportTitle = "交费通服务新增办理用户数量报表";
%>  
...
$(function() {
	...
	var reportfile_m = "/zhht/jft/tas_user_increment_m.raq";//月报表文件
	var reportfile_d = "/zhht/jft/tas_user_increment_d.raq";//日报表文件
...
<body>
	...
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/zhht/jft/tas_user_increment_d.raq"/>
