...
String reportTitle = "金融通道失败交易分析日报";
%>  
...
$(function() {
	...
	var reportfile_m = "/jrtdfx/adl_coop_fail_trade_d.raq";//月报表文件
	var reportfile_d = "/jrtdfx/adl_coop_fail_trade_d.raq";//日报表文件
	var reportfile_w = "/jrtdfx/adl_coop_fail_trade_d.raq";//周报表文件
...
<body>
	...
	<input id="reportfile" type="hidden" name="reportCondis.reportName" value="/jrtdfx/adl_coop_fail_trade_d.raq"/>
