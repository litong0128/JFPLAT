...
@Controller  
@Scope("prototype")  
public class WoygzcReportAction extends BaseActionSupport {

	private static Logger logger = Logger.getLogger(WoygzcReportAction.class);
	...
	public String mertrade(){
		return "mertrade";

	}	
	public String provtrade(){
		return "provtrade";
